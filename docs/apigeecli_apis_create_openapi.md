...
```
      ...
      --configfile string                         Deployment config file (default "config.json")
      --createOnline                              Create API proxy revision online to the configured org and environment
  ...
  -h, --help                                      help for openapi
      --import                                    Import API Proxy after generation from spec
