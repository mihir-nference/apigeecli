...
```
  ...
  -r, --role string   IAM Role Type, must be one of: mart, analytics, all, logger, connect, cassandra, watcher, sync, admin, api-admin, env-admin, dev-admin, readonly-admin
```
